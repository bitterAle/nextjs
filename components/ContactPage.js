  ...
  <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    <div className="grid grid-cols-1 gap-x-16 gap-y-8 lg:grid-cols-5">
      <div className="lg:col-span-2 lg:py-12">
        <p className="max-w-xl text-neutral-950 text-lg">
        ...
        <div className="mt-8">
          <a href="#" className="text-3xl font-bold text-blue-700"> +(254)705-877819 </a>

          <address className="mt-2  text-black not-italic">7450-00300 Ongata Rongai, Nairobi. Kenya</address>
        </div>
      </div>
